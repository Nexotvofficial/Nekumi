...
def scrape_manhwa(url):
    ...
    if existing.data:
        ...
        # No actualizamos toda la info para que sea más rápido, solo pasamos a los capítulos
    else:
        payload = {
            "title": manga_title,
    ...
    # OPTIMIZACIÓN: Obtener de golpe todos los capítulos que ya existen para este manhwa
