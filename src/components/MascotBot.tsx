...
export default function MascotBot() {
  ...
  const [position, setPosition] = useState({ x: -1000, y: -1000 }); // Render off-screen initially
  ...
  // Use dicebear miniavs as cute placeholders
  ...
  return (
    <>
      ...
      <div 
        ...
        style={{ transform: \	ranslate(\px, \px)\, touchAction: "none" }}
        className={\ixed top-0 left-0 z-[9999] flex flex-col items-center select-none \\}
      >
        {isPlaying && (
          <iframe
            width="0" height="0"
        ...
        <div 
          ...
          className={\	ransition-all duration-300 transform origin-bottom \ bg-[#1a1a2e]/95 border border-[#a855f7]/30 rounded-2xl p-4 shadow-xl shadow-purple-900/40 w-64 backdrop-blur-md cursor-default\}
        >
          ...
          <div className="flex flex-col gap-2">
            <button 
              ...
              className={\lex items-center justify-center gap-2 px-3 py-2.5 rounded-xl text-xs font-bold transition-all \\}
            >
