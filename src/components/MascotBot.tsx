        ...
        {isPlaying ? (
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-[#c084fc] text-xs font-medium">Reproductor Oficial de YouTube</p>
            </div>
            ...
            <p className="text-[10px] text-gray-500 mt-2 text-center">Nota: Canciones oficiales (VEVO) pueden estar bloqueadas por derechos de autor.</p>
          </div>
        ) : (
          <div className="mb-4">
